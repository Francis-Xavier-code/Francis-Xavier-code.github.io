...
>
> ⚠️：标题超链接指向其软件的官网地址，点击即可跳转

### 为什么要写这篇文章

> 因为一些工具不整理，后续我自己换新电脑后也会忘记那些是好用的软件，如果没有这篇文章当导航栏就等于增加了选择工具和查阅工具带来的时间损耗。

## 工具推荐

> 由于本人只有 Windows 的生产电脑，所以此篇文章只讲本人使用过的 Windows 端工具。在此帖子中，我会介绍生产力工具的使用场景、功能，同时附带使用界面截图，让你快速了解这是一个什么样的工具。
...
### 1.5 [SumatraPDF](https://www.sumatrapdfreader.org/free-pdf-reader)——好用、轻量的PDF阅读器

在查看一些PDF的时候，尝尝因为阅读体验大打折扣，因此一个好的PDF阅读器就很重要。
...
### 1.6 [Typora](https://typora.io/)——好用的Markdown编辑器

在日常中，我们需要写一些笔记或者文档，此时Markdown最合适不过，因此需要好的编辑器

> 顺带提一嘴，这个软件唯一不好的就是要付费，具体价格和相关说明请看文档
...
如上图所示，小白在下载软件时往往无法分辨真正的官网。在生产环境中最怕的就是下载到不干净的东西，造成严重的损失，因此找到官方网站很有必要。同时我也再次呼吁各路人士增加对此类网站的举报，为互联网净土贡献一份自身的力量
...
- 2026-06-30 软件更新到 `1.5`
- 2026-06-29 创建了此篇文章，推荐的软件更新到 `1.4`
